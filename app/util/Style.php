...
class Style
{
    public static function routeCssClass()
    {
        ...
        $notification = '/projects/hcdv-6/resource/view/notification.php';
        $adminHome = '/projects/hcdv-6/resource/view/admin/home.php';
        $route = strtolower($_SERVER['PHP_SELF']);
        $isAdmin = str_contains($route, '/projects/hcdv-6/resource/view/admin/');
        if ($route === $index) {
