...
<div class="w-full px-20 py-4 relative drop-shadow-2xl h-complete">
    <div class="rounded bg-slate-300 px-8 w-full h-full grid grid-cols-3 py-4 gap-4">
        <div class="col-span-2 gap-4 py-8 px-4 overflow-scroll h-full grid grid-cols-12 custom-scroll">
            <div class="col-span-11 grid grid-cols-12 bg-white max-h-20 rounded-md hover:drop-shadow-lg">
                <div class="col-span-2">
                    <img src="../../../storage/images/profile/kampachi.jpg" alt="" class=" max-h-20 rounded-l-md">
                </div>
                <div class=" col-span-9 pr-4">
                    <div class="h1 text-lg font-bold">The Zahir</div>
                    <hr>
                    <div class="grid grid-cols-8">
                        <div class="col-span-7">
                            <p class="font-semibold">Owner: someone</p>
                            <span class=" text-xs text-gray-500">Mar-3-2023</span>
                        </div>
        ...
        <div class="grid place-content-center">
            <img src="../../picture/svg/undraw_fresh_notification_re_whq4.svg" alt="" class="w-full -ml-3">
        </div>
