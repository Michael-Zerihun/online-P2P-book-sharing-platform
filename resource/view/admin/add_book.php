...
include '../../../app/handler/admin/add_book.create.php';
?>
...
<div class="w-full px-20 py-4 relative drop-shadow-2xl h-complete">
    <div class="rounded bg-slate-300 px-8 w-full h-full grid grid-cols-3 py-4 gap-4">
                ...
                <form action="./add_book.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12">
                        <div class="grid gap-4 col-span-3 justify-center px-2">
                            <label for="image" class="bg-green-400 rounded-md p-1 w-full">
                                <img src="../../picture//book.png" alt="" class=" w-full" id="preview">
                        ...
                        <div class="grid col-span-9 gap-4 pl-4">
                            <div class="grid grid-rows-3 grid-flow-col py-4 pr-16">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="bookName" id="bName" class="border-b bg-slate-200 border-blue-400 rounded-sm outline-blue-600 w-full p-1">
                                </div>
                                <div class="w-full">
                                    <label for="owner" class="font-bold text-gray-900">Owner Name</label><br>
                                    <input type="text" name="owner" id="owner" class="border-b bg-slate-200 border-blue-400 rounded-sm outline-blue-600 w-full p-1">
                                </div>
                                <div class="w-full">
                                    <label for="genre" class="font-bold text-gray-900">Genre</label><br>
                                    <input type="text" name="genre" id="genre" class="border-b bg-slate-200 border-blue-400 rounded-sm outline-blue-600 w-full p-1">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid pl-4 pr-8 gap-4 py-2">
                        <div class="grid gap-4">
                            <div class="grid">
                                ...
                                <textarea name="shortDisc" id="shortDisc" cols="30" rows="5" class="border border-blue-400 rounded-md outline-blue-600 custom-scroll p-2"></textarea>
                            </div>
                            <div class="grid">
                                <label for="longDisc" class="font-bold text-gray-900">Summary</label>
                                <textarea name="longDisc" id="longDisc" cols="10" rows="10" class="border border-blue-400 rounded-md outline-blue-600 custom-scroll p-2"></textarea>
                            </div>
                        </div>
                        <div class="flex gap-4 justify-end">
                            <input type="reset" name="reset" value="Clear form" class="border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white rounded h-8 px-4">
                            <a href="./book.php?b=0" class="border border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded h-8 px-4">Cancel</a>
        ...
        <div class="grid place-content-center">
            <img src="../../picture/svg/undraw_new_entries_re_cffr.svg" alt="" class="w-full">
        </div>
